...
We have a state file with the data.  Let's grab it.

`Files > Course Files > Meeting 4 > week-4-2024.state.rda`

The assignment elements on Berkeley admissions will form my example.

---
## A Little Bit on Filters

![Load data](./data/Screenshot 2024-09-23 at 3.23.42 PM.png)

---

What values do we want?  `|` is OR and `&` is AND.

![Filter](./data/Screenshot 2024-09-23 at 3.24.21 PM.png)

---
## Voila

![Picture](./data/Screenshot 2024-09-23 at 3.28.08 PM.png)
...
![Store it](./data/Screenshot 2024-09-23 at 3.24.43 PM.png)
...
Prob.Def <- readPNG("./data/ETJ-Probability.png")
...
---
# A Crucial Idea: Independence

My preferred way to think about this logical independence.  Do I learn something about X from Y?

---
# The Second Half of Chapter 3

Is mostly a lead-in to Chapter 4.  It defines random variables and probability distributions.  Next time we will take on the end of chapter 3 and chapter 4.

That will include sampling, probability distributions, random variables and examples.

---
# Maximizing `esquisse` and `radiant`

The keys are:
1. matching object names in the state file and your esquisse data.
2. the `code chunk syntax`.  `radiant` code has it.  It is in an announcement that went live at 6:00PM today.
