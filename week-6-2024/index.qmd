---
title: "Probability Distributions: Discrete Distributions"
...
- The simplest way to think about it is, "do I learn something more about x by knowing y than not".  If two things are independent, I don't need to care about y if x is my objective.  But it is essentially, do I care at all or not?  If I care, even a tiny bit, they are not independent.  **This is a feature, not a bug.**
...
I am going to build the assessment around this idea of calibration because it combines everything we have done to this point.  Here is a sample question sequence.  A similar sequence for a binomial or Poisson would also arise.  I will also come up with a quality control example to combine probabilities and Bayes Rule.  Suppose 3 machines, I give you the normal "verbs" and some specs.  You have to calculate probabilities of total errors, unders, and overs for each.  It's one computation for each.  I give you a rate of production for each machine.  We find an over/under, what is the probability each machine produced it?
