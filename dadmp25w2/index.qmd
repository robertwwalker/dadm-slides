...
format: 
   revealjs:
     ...
     scrollable: true
     logo: AGSMlogo.jpeg
     footer: "DADM-PDX: Week 2 (3 Sep 2025)"
     chalkboard: true
...
The data are Bond.Funds.  We have an ID, Type, Assets, Fees [Yes or No], Expense Ratio, Returns in 2009, 3 year, 5 year, and a Risk classification.  

- A [link to the data in Excel format NB auto-downloads.](https://github.com/robertwwalker/DADMStuff/raw/master/BondFunds.xlsx).    
- A [link to the data in csv format NB auto-downloads.](https://github.com/robertwwalker/DADMStuff/raw/master/BondFunds.csv).
